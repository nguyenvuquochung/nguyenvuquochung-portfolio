const P5_PROJECTS = [
  {
    id:'supper-live-15-05-ha-linh',
    title:'SUPPER LIVE 15.05 – HA LINH OFFICIAL',
    en:'SUPPER LIVE 15.05 – HA LINH OFFICIAL',
    year:'2026',
    role:'2nd Assistant Director',
    role_vi:'Trợ lí đạo diễn 2',
    desc:'Funny viral clips promoting the Supper Live session on May 15th on the Ha Linh Official channel.',
    desc_vi:'Các funny viral clip giới thiệu phiên live Supper Live 15 tháng 05 trên kênh Ha Linh Official.',
    about:[
      'Các funny viral clip giới thiệu phiên live Supper Live 15 tháng 05 trên kênh Ha Linh Official.',
    ],
    about_en:[
      'Funny viral clips promoting the Supper Live session on May 15th on the Ha Linh Official channel.',
    ],
    credits:[
  ...
  {
    id:'supper-live-06-06-ha-linh',
    title:'SUPPER LIVE 06.06 – HA LINH OFFICIAL',
    en:'SUPPER LIVE 06.06 – HA LINH OFFICIAL',
    year:'2026',
    role:'2nd Assistant Director',
    role_vi:'Trợ lí đạo diễn 2',
    desc:'Funny viral clips promoting the Supper Live session on June 6th on the Ha Linh Official channel.',
    desc_vi:'Các funny viral clip giới thiệu phiên live Supper Live 06 tháng 06 trên kênh Ha Linh Official.',
    about:[
      'Các funny viral clip giới thiệu phiên live Supper Live 06 tháng 06 trên kênh Ha Linh Official.',
    ],
    about_en:[
      'Funny viral clips promoting the Supper Live session on June 6th on the Ha Linh Official channel.',
    ],
    credits:[
      { label:'Production House', label_vi:'Đơn vị sản xuất', value:'Fujima Pictures Production' },
      { label:'Executive Producer', label_vi:'Giám đốc điều hành', value:'Thông Hồ' },
  ...
  },
  {
    ...
    stills:[
      'assets/myproject/ad/DVKKH/sill/image1.jpg',
    ],
    bts:[
      'assets/myproject/ad/DVKKH/CREW/image1.jpg',
    ],
    video:'https://www.youtube.com/watch?v=fGTSLTKOX0k',
    video_label:'Link xem',
    video_label_en:'Watch here',
    img:'assets/myproject/ad/686960184_1946056099605690_2548582344180028003_n.jpg',
  },
  {
    ...
    stills:[],
    bts:[
      'assets/myproject/ad/cbhv/image1.jpg',
    ],
    video:'https://www.youtube.com/watch?v=1Xg5xW5IDo4',
    video_label:'Link xem',
    video_label_en:'Watch here',
    img:'assets/myproject/ad/698473603_122111306996807900_6351755015085341106_n.jpg',
  },
  {
