const P3_PROJECTS = [
  {
    ...
    credits:[
      ...
      { label:'1st Assistant Director', value:'Phạm Hữu Trí' },
      { label:'2nd Assistant Director', value:'Vivian Lê' },
      { label:'Producer',               value:'Thục Mai' },
      { label:'1st Production Assistant', value:'Quốc Hưng' },
      { label:'2nd Production Assistant', value:'Khương Ngọc' },
      { label:'3rd Production Assistant', value:'Đặng Thành Tâm' },
      { label:'Director of Photography',  value:'Mạch Mẫn Nhi' },
      { label:'Gaffer',                   value:'Hà Hiếu' },
      { label:'Production Designer',      value:'Dzuy Tom' },
      { label:'Starring',                 value:'Đào Duy Bảo Định, Bế Ngọc Diệp, Hoan Công, Hạnh Phúc, Phil Solo' },
    ],
    stills:[
